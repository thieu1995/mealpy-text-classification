#!/usr/bin/env python
# Created by "Thieu" at 23:50, 01/10/2022 ----------%                                                                               
...
accuracy = training_process(LogisticRegression(max_iter=500), X_train, df["y_train"], X_valid, df["y_valid"])
...
# accuracy = training_process(LogisticRegression(), X_train, df["y_train"], X_valid, df["y_valid"])
...
## Features asCharacter Level TF IDF Vectors
